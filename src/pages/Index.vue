  ...
  <Layout>
    ...
    <div class="hero container-inner mx-auto flex flex-col sm:flex-row justify-between py-16">
      <div class="text-4xl font-bold w-full text-center">
        <div class="leading-tight">How to deploy a PWA headless <span class="text-green-700">Shopify</span> site using <span class="text-green-700">Gridsome</span>.</div>
      </div>
    </div>

    <div id="products" class="flex flex-wrap mb-4 max-w-5xl mx-auto">
			<div class="md:w-1/2 lg:w-1/3 w-full px-2" v-for="({ node: product }) in featuredProducts">
